    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <form method="POST" action="{{ route('incident.wizard.postStep3') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="form-label">Email (optional — to receive your tracking code)</label>
                    <input type="email" name="email" class="form-control" placeholder="you@example.com">
                    <small class="text-muted">This is only used to send your tracking code and is never stored.</small>
                </div>

                <div class="alert alert-info small">
                    Your report is anonymous. This field is optional and not required to submit.
                </div>
